...
DATABASES = {
    "default": {
        ...
        "NAME": config("POSTGRES_DB", default="telemed"),
        "USER": config("POSTGRES_USER", default="telemed"),
        "PASSWORD": config("POSTGRES_PASSWORD", default="telemed_secret_password"),
...
DEFAULT_FROM_EMAIL = config("DEFAULT_FROM_EMAIL", default="noreply@telemed.com")
